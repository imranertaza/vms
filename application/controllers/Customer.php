...
class Customer extends CI_Controller {
	...
	public function ledger($iCustId){

		$data['customerid'] = $iCustId;
		$data['customerlist'] = $this->customer_model->getall_customer_for_dropdown();
		$this->template->template_render('ledger',$data);
	}
	public function fetch_customer(){

		$iCust_id = $this->input->post('cust_id');
		$res['customer_info'] = $this->customer_model->getall_customer_by_id($iCust_id);
		$res['company_info'] = $this->db->select('*')->from('settings')->get()->result_array();
