...
class vehicle_model extends CI_Model{
	...
	public function get_vehicleLimit(){
		return $this->db->select('s_no_of_veh_allowed')->from('settings')->get()->result_array();
	}
	public function get_vehicleCount(){
		return $this->db->select('count(v_id) as "count"')->from('vehicles')->get()->result_array();
	}
