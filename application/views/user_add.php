                 ...
                 <?php } ?>
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                      ...
                      <div class="form-group mr-4">
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" value="1" <?php if(isset($userdetails[0]['lr_vech_list'])) { echo ($userdetails[0]['lr_settings_smtp']==1 ? 'checked' : ''); } ?> name="permissions[lr_settings_smtp]" class="custom-control-input" id="lr_settings_smtp">
                          <label class="custom-control-label" for="lr_settings_smtp">Smtp Settings</label>
                        </div>
                      </div>
                      <div class="form-group mr-4">
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" value="1" <?php if(isset($userdetails[0]['lr_vech_list'])) { echo ($userdetails[0]['lr_settings_email_temp']==1 ? 'checked' : ''); } ?> name="permissions[lr_settings_email_temp]" class="custom-control-input" id="lr_settings_email_temp">
                          <label class="custom-control-label" for="lr_settings_email_temp">Smtp Settings</label>
                        </div>
                      </div>
                  </div>
                  </div>
