                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link active" href="#basicinfo" data-toggle="tab">Basic
                                    Info</a></li>
                            <li class="nav-item"><a class="nav-link " href="#bookings" data-toggle="tab">Bookings</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="#vechicle_geofence" data-toggle="tab">Geofence</a>
                            </li>
                        ...
                        <div class="tab-content">
                                    ...
                                    <?php if (!empty($bookings)) {
                                        ...
                                        foreach ($bookings as $bookingsdata) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="icon" target="_blank"
                                                       href="<?php echo base_url(); ?>trips/details/<?php echo output($bookingsdata['t_id']); ?>">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                </td>
                                            </tr>
                            ...
                            <div class="tab-pane active" id="basicinfo">
                                <table class="table table-sm table-bordered">
                                    ...
                                    <tr>
                                        <td>Tyre Sizes</td>
                                        <td><?= output($vehicledetails['v_tyre_sizes']) ?></td>
                                    </tr>
                                    <tr>
                                        <td>No of Tyres</td>
                                        <td><?= output($vehicledetails['v_no_of_tyres']) ?></td>
                                    </tr>
                                    <tr>
                                        <td>Battery Detail</td>
                                        <td><?= output($vehicledetails['v_battery_detail']) ?></td>
                                    </tr>
                                    <tr>
                                        <td>Income Account</td>
                                        <td><?= output($vehicledetails['v_income_account']) ?></td>
                                    </tr>
                                    <tr>
                                        <td>Expense Account</td>
                                        <td><?= output($vehicledetails['v_expense_account']) ?></td>
                                    </tr>
                                    <!-- @Nasir developed-->
                                ...
                                <div class="col-sm-3">
                                    <a href="<?= base_url(); ?>vehicle/editvehicle/<?= $vehicledetails['v_id']; ?>">
                                        <button type="button" class="btn btn-block btn-success btn-sm">Edit Info
                                        </button>
                                    </a>
                                </div>
                            </div>
