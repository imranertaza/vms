        ...
        <form method="post" id="customer_add" class="card"
            ...
            <div class="card-body">
                        ...
                        <div class="col-sm-6 col-md-2">
                            <div class="form-group">
                                ...
                                <select id="c_isactive" name="c_isactive" class="form-control " required="">
                                    ...
                                    <option <?php echo (isset($customerdetails) && $customerdetails[0]['c_isactive'] == 1) ? 'selected' : '' ?>
                                            value="1">Active
                                    </option>
                                    <option <?php echo (isset($customerdetails) && $customerdetails[0]['c_isactive'] == 0) ? 'selected' : '' ?>
                                            value="0">Inactive
                                    </option>
                                </select>
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <div class="form-group">
                            <label class="form-label">Opening Balance<span class="form-required">*</span></label>
                            <input class="form-control" required="true" id="c_opening_balance" autocomplete="off"
                                      placeholder="Opening Balance" value="<?php echo (isset($customerdetails)) ? $customerdetails[0]['c_opening_balance'] : '' ?>"
                                      name="c_opening_balance">
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit"
                            class="btn btn-primary"> <?php echo (isset($customerdetails)) ? 'Update Customer' : 'Add Customer' ?></button>
                </div>
            </div>
        </form>
    </div>
