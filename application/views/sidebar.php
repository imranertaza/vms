      ...
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php }  if(userpermission('lr_reports')) { ?>
            ...
            <?php } if(userpermission('lr_settings_smtp') || userpermission('lr_settings_email_temp')) { //userpermission('lr_settings') ?>
            <li class="nav-item has-treeview <?php echo ((activate_menu('smtpconfig'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('email_template'))=='active') ? 'menu-open':'' ?><?php echo ((activate_menu('edit_email_template'))=='active') ? 'menu-open':'' ?>">
               ...
               <ul class="nav nav-treeview">
                  <?php if(userpermission('lr_settings_smtp')) {  ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>settings/packagesubscription" class="nav-link <?php echo activate_menu('smtpconfig');?>">
                        <i class="nav-icon fas faa-plus"></i>
                  ...
                  <?php } if(userpermission('lr_settings_email_temp')) { ?>
                  <li class="nav-item">
            ...
            <?php if($this->session->userdata('session_data')['u_id'] == 1){ ?>
            <li class="nav-item has-treeview <?php echo ((activate_menu('websitesetting'))=='active') ? 'menu-open':'' ?>">
               <a href="#" class="nav-link <?php echo activate_menu('websitesetting');?><?php echo activate_menu('email_template');?> <?php echo activate_menu('smtpconfig');?><?php echo activate_menu('edit_email_template');?>">
                  <i class="nav-icon fa fa-dollar-sign"></i>
                  <p>
                     Super Admin 
               ...
               <ul class="nav nav-treeview">
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>packages/subscription" class="nav-link <?php echo activate_menu('websitesetting');?>">
                        <i class="fas fa-cosg icon nav-icon"></i>
